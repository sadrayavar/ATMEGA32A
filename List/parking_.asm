...
; 0000 00B5     }
; 0000 00B6 
; 0000 00B7     sprintf(buff, "Z=%d %d/%d/%d", capacity, year, month, day);
_0x1E:
	MOVW R30,R28
	ADIW R30,17
	ST   -Y,R31
	...
	CALL _sprintf
	ADIW R28,20
; 0000 00B8     sprintf(buff2, "%d:%d:%d  R=%d ", hour, minute, second, reserved);
	CALL SUBOPT_0xA
	__POINTW1FN _0x0,26
	ST   -Y,R31
	ST   -Y,R30
...
_0x24:
	CALL SUBOPT_0x5
; 0000 00C9     lcd_puts(buff2);
	CALL SUBOPT_0xB
; 0000 00CA     delay_ms(25);
	CALL SUBOPT_0xC
; 0000 00CB   }
	RJMP _0x17
; 0000 00CC }
...
_0x31:
; 0000 00F4 
; 0000 00F5     if (PINA.4 == 0)
_0x2D:
	SBIC 0x19,4
	RJMP _0x32
; 0000 00F6     { // Back
; 0000 00F7       while (PINA.4 == 0);
_0x33:
	SBIS 0x19,4
	RJMP _0x33
; 0000 00F8       return 0;
...
; 0000 00F9     }
; 0000 00FA 
; 0000 00FB     if (PINA.2 == 0 & _chose == 0)
_0x32:
	CALL SUBOPT_0xD
	CALL SUBOPT_0xE
	BREQ _0x36
; 0000 00FC     { // chose time_setting
...
; 0000 00FF     }
; 0000 0100 
; 0000 0101     if (PINA.2 == 0 & _chose == 1)
_0x36:
	CALL SUBOPT_0xD
	CALL SUBOPT_0xF
	BREQ _0x3A
; 0000 0102     { // chose in_out_search
; 0000 0103       while (PINA.2 == 0);
_0x3B:
	SBIS 0x19,2
	RJMP _0x3B
; 0000 0104       in_out_search();
	RCALL _in_out_search
; 0000 0105     }
; 0000 0106 
; 0000 0107     if (PINA.2 == 0 & _chose == 2)
_0x3A:
	CALL SUBOPT_0xD
	CALL SUBOPT_0x10
	BREQ _0x3E
; 0000 0108     { // chose reserve
; 0000 0109       while (PINA.2 == 0);
_0x3F:
	SBIS 0x19,2
	RJMP _0x3F
; 0000 010A       reserve_park();
	RCALL _reserve_park
; 0000 010B     }
; 0000 010C 
; 0000 010D     if (PINA.2 == 0 & _chose == 3)
_0x3E:
	CALL SUBOPT_0xD
	LDI  R30,LOW(3)
	CALL __EQB12
...
; .FSTART _time_set
	PUSH R15
; 0000 011B   bit _chose = 0;
; 0000 011C   char buff[17];
; 0000 011D   while (1)
	SBIW R28,17
;	_chose -> R15.0
;	buff -> Y+0
...
_0x46:
; 0000 011E   {
; 0000 011F     if (_chose == 0)
	SBRC R15,0
	RJMP _0x49
; 0000 0120     {
; 0000 0121       sprintf(buff, "Set min=%d  >", minute);
	CALL SUBOPT_0xA
	...
	CALL SUBOPT_0x11
; 0000 0122       lcd_clear();
; 0000 0123       lcd_puts(buff);
; 0000 0124     }
; 0000 0125 
; 0000 0126     if (_chose == 1)
_0x49:
	SBRS R15,0
	RJMP _0x4A
; 0000 0127     {
; 0000 0128       sprintf(buff, "Set hour=%d  >", hour);
	CALL SUBOPT_0xA
...
; 0000 012B     }
; 0000 012C 
; 0000 012D     if (PINA.1 == 0 & _chose == 0)
_0x4A:
	CALL SUBOPT_0x12
	CALL SUBOPT_0xE
	BREQ _0x4B
; 0000 012E     { // UP     min
; 0000 012F       while (PINA.1 == 0);
_0x4C:
	SBIS 0x19,1
	RJMP _0x4C
; 0000 0130       minute++;
	INC  R11
; 0000 0131       if (minute > 59)
	LDI  R30,LOW(59)
	CP   R30,R11
	BRGE _0x4F
; 0000 0132         minute = 0;
...
_0x4F:
; 0000 0134 
; 0000 0135     if (PINA.0 == 0 & _chose == 0)
_0x4B:
	CALL SUBOPT_0x13
	CALL SUBOPT_0xE
	BREQ _0x50
; 0000 0136     { // DOWN    min
; 0000 0137       while (PINA.0 == 0);
_0x51:
	SBIS 0x19,0
	RJMP _0x51
; 0000 0138       minute--;
	DEC  R11
; 0000 0139       if (minute < 0)
	LDI  R30,LOW(0)
	CP   R11,R30
	BRGE _0x54
; 0000 013A         minute = 59;
...
_0x54:
; 0000 013C 
; 0000 013D     if (PINA.1 == 0 & _chose == 1)
_0x50:
	CALL SUBOPT_0x12
	CALL SUBOPT_0xF
	BREQ _0x55
; 0000 013E     { // UP    hour
; 0000 013F       while (PINA.1 == 0);
_0x56:
	SBIS 0x19,1
	RJMP _0x56
; 0000 0140       hour++;
	INC  R10
; 0000 0141       if (hour > 23)
	LDI  R30,LOW(23)
	CP   R30,R10
	BRGE _0x59
; 0000 0142         hour = 0;
...
_0x59:
; 0000 0144 
; 0000 0145     if (PINA.0 == 0 & _chose == 1)
_0x55:
	CALL SUBOPT_0x13
	CALL SUBOPT_0xF
	BREQ _0x5A
; 0000 0146     { // DOWN    hour
; 0000 0147       while (PINA.0 == 0);
_0x5B:
	SBIS 0x19,0
	RJMP _0x5B
; 0000 0148       hour--;
...
_0x5E:
; 0000 014C 
; 0000 014D     if (PINA.3 == 0)
_0x5A:
	SBIC 0x19,3
	RJMP _0x5F
; 0000 014E     { // NEXT
; 0000 014F       while (PINA.3 == 0);
_0x60:
	SBIS 0x19,3
	RJMP _0x60
; 0000 0150       _chose = !_chose;
	LDI  R30,LOW(1)
	EOR  R15,R30
; 0000 0151     }
; 0000 0152 
; 0000 0153     if (PINA.4 == 0)
_0x5F:
	SBIC 0x19,4
	RJMP _0x63
; 0000 0154     { // Back
; 0000 0155       while (PINA.4 == 0);
_0x64:
	SBIS 0x19,4
	RJMP _0x64
; 0000 0156       return 0;
...
; .FSTART _in_out_search
	PUSH R15
; 0000 0160   char t_month = month, buff[17], buff2[17];
; 0000 0161   char i_temp = i;
; 0000 0162   bit bit_m = 0;
; 0000 0163   while (1)
	SBIW R28,34
	ST   -Y,R17
	ST   -Y,R16
...
; 0000 0164   {
; 0000 0165 
; 0000 0166     if (PINA.1 == 0)
	SBIC 0x19,1
	RJMP _0x6A
; 0000 0167     { // UP
; 0000 0168       while (PINA.1 == 0);
_0x6B:
	SBIS 0x19,1
	RJMP _0x6B
; 0000 0169       i_temp++;
...
; 0000 0170       }
; 0000 0171 
; 0000 0172       if (t_month <= 6 & i_temp > 31 & bit_m == 1)
_0x6E:
	MOV  R26,R17
	LDI  R30,LOW(6)
	CALL __LEB12U
...
; 0000 0177       }
; 0000 0178 
; 0000 0179       if (t_month > 6 & i_temp > 30 & bit_m == 1)
_0x6F:
	MOV  R26,R17
	LDI  R30,LOW(6)
	CALL __GTB12U
...
; 0000 017E       }
; 0000 017F 
; 0000 0180       if (t_month == 12 & i_temp > 29 & bit_m == 1)
_0x70:
	MOV  R26,R17
	LDI  R30,LOW(12)
	CALL __EQB12
...
; 0000 0185       }
; 0000 0186 
; 0000 0187       if (t_month == 0)
_0x71:
	CPI  R17,0
	BRNE _0x72
; 0000 0188         t_month = 12;
	LDI  R17,LOW(12)
; 0000 0189 
; 0000 018A       if (t_month > 12)
_0x72:
	CPI  R17,13
	BRLO _0x73
; 0000 018B         t_month = 1;
...
_0x73:
; 0000 018D 
; 0000 018E     if (PINA.0 == 0)
_0x6A:
	SBIC 0x19,0
	RJMP _0x74
; 0000 018F     { // DOWN
; 0000 0190       while (PINA.0 == 0);
_0x75:
	SBIS 0x19,0
	RJMP _0x75
; 0000 0191       i_temp--;
...
; 0000 0196         t_month--;
	SUBI R17,1
; 0000 0197 
; 0000 0198         if (t_month == 0)
	CPI  R17,0
	BRNE _0x79
; 0000 0199           t_month = 12;
	LDI  R17,LOW(12)
; 0000 019A 
; 0000 019B         if (t_month > 12)
_0x79:
	CPI  R17,13
	BRLO _0x7A
; 0000 019C           t_month = 1;
...
; 0000 01AF       }
; 0000 01B0 
; 0000 01B1       if (t_month == 0)
_0x7E:
	CPI  R17,0
	BRNE _0x7F
; 0000 01B2         t_month = 12;
	LDI  R17,LOW(12)
; 0000 01B3 
; 0000 01B4       if (t_month > 12)
_0x7F:
	CPI  R17,13
	BRLO _0x80
; 0000 01B5         t_month = 1;
...
_0x80:
; 0000 01B7 
; 0000 01B8     sprintf(buff, "%d/%d/%d ", year, t_month, i_temp);
_0x74:
	MOVW R30,R28
	ADIW R30,19
	ST   -Y,R31
	...
	CALL _sprintf
	ADIW R28,16
; 0000 01B9     sprintf(buff2, "in=%d out=%d", vurud_stat[i_temp], khuruj_stat[i_temp]);
	MOVW R30,R28
	ADIW R30,2
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 01BD     lcd_gotoxy(0, 1);
	CALL SUBOPT_0x5
; 0000 01BE     lcd_puts(buff2);
	MOVW R26,R28
	ADIW R26,2
	CALL _lcd_puts
; 0000 01BF 
; 0000 01C0     if (PINA.4 == 0)
	SBIC 0x19,4
	RJMP _0x81
; 0000 01C1     { // Back
; 0000 01C2       while (PINA.4 == 0);
_0x82:
	SBIS 0x19,4
	RJMP _0x82
; 0000 01C3       return 0;
...
_0x85:
; 0000 01D0   {
; 0000 01D1     sprintf(buff, "Reserved=%d", reserved);
	CALL SUBOPT_0xA
	...
	CALL SUBOPT_0x11
; 0000 01D2     lcd_clear();
; 0000 01D3     lcd_puts(buff);
; 0000 01D4 
; 0000 01D5     if (PINA.1 == 0)
	SBIC 0x19,1
	RJMP _0x88
; 0000 01D6     { // UP
; 0000 01D7       while (PINA.1 == 0);
_0x89:
	SBIS 0x19,1
	RJMP _0x89
; 0000 01D8       reserved++;
...
; 0000 01D9     }
; 0000 01DA 
; 0000 01DB     if (reserved >= 100)
_0x88:
	LDI  R30,LOW(100)
	CP   R4,R30
	BRLT _0x8C
; 0000 01DC     {
; 0000 01DD       reserved = 99;
	LDI  R30,LOW(99)
	MOV  R4,R30
; 0000 01DE     }
; 0000 01DF 
; 0000 01E0     if (PINA.0 == 0)
_0x8C:
	SBIC 0x19,0
	RJMP _0x8D
; 0000 01E1     { // DOWN
; 0000 01E2       while (PINA.0 == 0);
_0x8E:
	SBIS 0x19,0
	RJMP _0x8E
; 0000 01E3       reserved--;
...
; 0000 01E4     }
; 0000 01E5 
; 0000 01E6     if (reserved <= 0)
_0x8D:
	LDI  R30,LOW(0)
	CP   R30,R4
	BRLT _0x91
; 0000 01E7     {
; 0000 01E8       reserved = 0;
	CLR  R4
; 0000 01E9     }
; 0000 01EA 
; 0000 01EB     if (PINA.4 == 0)
_0x91:
	SBIC 0x19,4
	RJMP _0x92
; 0000 01EC     { // Back
; 0000 01ED       while (PINA.4 == 0);
_0x93:
	SBIS 0x19,4
	RJMP _0x93
; 0000 01EE       return 0;
...
; 0000 01FC     if (_chose == 1)
	...
	BRNE _0x99
; 0000 01FD     {
; 0000 01FE       sprintf(buff, "Set month=%d  >", month);
	CALL SUBOPT_0x18
	...
	CALL SUBOPT_0x19
; 0000 01FF       lcd_clear();
; 0000 0200       lcd_puts(buff);
; 0000 0201     }
; 0000 0202 
; 0000 0203     if (_chose == 0)
_0x99:
	CPI  R17,0
	BRNE _0x9A
; 0000 0204     {
; 0000 0205       sprintf(buff, "Set day=%d  >", day);
	CALL SUBOPT_0x18
	...
	CALL SUBOPT_0x19
; 0000 0206       lcd_clear();
; 0000 0207       lcd_puts(buff);
; 0000 0208     }
; 0000 0209 
; 0000 020A     if (_chose == 2)
_0x9A:
	CPI  R17,2
	BRNE _0x9B
; 0000 020B     {
; 0000 020C       sprintf(buff, "Set year=%d  >", year);
	CALL SUBOPT_0x18
	...
	CALL SUBOPT_0x19
; 0000 020D       lcd_clear();
; 0000 020E       lcd_puts(buff);
; 0000 020F     }
; 0000 0210 
; 0000 0211     if (PINA.1 == 0 & _chose == 1)
_0x9B:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0xF
	BREQ _0x9C
; 0000 0212     { // UP     month
; 0000 0213       while (PINA.1 == 0);
_0x9D:
	SBIS 0x19,1
	RJMP _0x9D
; 0000 0214       month++;
...
_0xA0:
; 0000 0218 
; 0000 0219     if (PINA.0 == 0 & _chose == 1)
_0x9C:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0xF
	BREQ _0xA1
; 0000 021A     { // DOWN    month
; 0000 021B       while (PINA.0 == 0);
_0xA2:
	SBIS 0x19,0
	RJMP _0xA2
; 0000 021C       month--;
...
_0xA5:
; 0000 0220 
; 0000 0221     if (PINA.1 == 0 & _chose == 0)
_0xA1:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0xE
	BREQ _0xA6
; 0000 0222     { // UP    day
; 0000 0223       while (PINA.1 == 0);
_0xA7:
	SBIS 0x19,1
	RJMP _0xA7
; 0000 0224       day++;
...
_0xAA:
; 0000 0229 
; 0000 022A     if (PINA.0 == 0 & _chose == 0)
_0xA6:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0xE
	BREQ _0xAB
; 0000 022B     { // DOWN    day
; 0000 022C       while (PINA.0 == 0);
_0xAC:
	SBIS 0x19,0
	RJMP _0xAC
; 0000 022D       day--;
...
_0xAF:
; 0000 0232 
; 0000 0233     if (PINA.0 == 0 & _chose == 2)
_0xAB:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0x10
	BREQ _0xB0
; 0000 0234     { // DOWN    year
; 0000 0235       while (PINA.0 == 0);
_0xB1:
	SBIS 0x19,0
	RJMP _0xB1
; 0000 0236       year--;
...
_0xB4:
; 0000 023A 
; 0000 023B     if (PINA.1 == 0 & _chose == 2)
_0xB0:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0x10
	BREQ _0xB5
...
; 0000 023E       year++;
	...
	ST   -X,R31
	ST   -X,R30
; 0000 023F       // if(year>1404)
; 0000 0240       // year=0;
; 0000 0241     }
; 0000 0242 
; 0000 0243     if (PINA.3 == 0)
_0xB5:
	SBIC 0x19,3
	RJMP _0xB9
; 0000 0244     { // NEXT
; 0000 0245       while (PINA.3 == 0);
_0xBA:
	SBIS 0x19,3
	RJMP _0xBA
; 0000 0246       _chose++;
	SUBI R17,-1
; 0000 0247       if (_chose >= 3)
	CPI  R17,3
	BRLO _0xBD
; 0000 0248         _chose = 0;
	LDI  R17,LOW(0)
...
_0xBD:
; 0000 024A 
; 0000 024B     if (PINA.4 == 0)
_0xB9:
	SBIC 0x19,4
	RJMP _0xBE
; 0000 024C     { // Back
; 0000 024D       while (PINA.4 == 0);
_0xBF:
	SBIS 0x19,4
	RJMP _0xBF
; 0000 024E       return 0;
