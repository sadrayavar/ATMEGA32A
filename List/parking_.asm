...
; 0000 0065   n_vurud++;
	...
	ADIW R30,1
	MOVW R6,R30
; 0000 0066   if ((capacity) <= 0)
	LDI  R30,LOW(0)
	CP   R30,R5
	BRLT _0x13
; 0000 0067   {
; 0000 0068     capacity = 0;
	CLR  R5
; 0000 0069     _full = 1;
	SET
	RJMP _0xC4
...
; 0000 006E   }
; 0000 006F 
; 0000 0070   if ((capacity + reserved) >= 100)
	CALL SUBOPT_0x4
	BRLT _0x15
; 0000 0071   {
; 0000 0072     capacity = 100 - reserved;
	LDI  R30,LOW(100)
	SUB  R30,R4
	MOV  R5,R30
; 0000 0073     _emp = 1;
...
; .FSTART _main
; 0000 007D 
; 0000 007E   char buff[17], buff2[17];
; 0000 007F 
; 0000 0080   // GICR|=0xC0;
; 0000 0081   // MCUCR=0x0A;
...
; 0000 009A #asm("sei")
	sei
; 0000 009B   capacity = capacity - reserved;
	SUB  R5,R4
; 0000 009C 
; 0000 009D   while (1)
_0x17:
...
; .FSTART _time_set
	PUSH R15
; 0000 0121   bit _chose = 0;
; 0000 0122   char buff[17];
; 0000 0123   while (1)
	SBIW R28,17
;	_chose -> R15.0
;	buff -> Y+0
...
; 0000 020E   {
; 0000 020F 
; 0000 0210     if (_chose == 1)
	CPI  R17,1
	BRNE _0x99
; 0000 0211     {
; 0000 0212       sprintf(buff, "Set month=%d  >", month);
	CALL SUBOPT_0x18
	...
	CALL SUBOPT_0x19
; 0000 0213       lcd_clear();
; 0000 0214       lcd_puts(buff);
; 0000 0215     }
; 0000 0216 
; 0000 0217     if (_chose == 0)
_0x99:
	CPI  R17,0
	BRNE _0x9A
; 0000 0218     {
; 0000 0219       sprintf(buff, "Set day=%d  >", day);
	CALL SUBOPT_0x18
	...
	CALL SUBOPT_0x19
; 0000 021A       lcd_clear();
; 0000 021B       lcd_puts(buff);
; 0000 021C     }
; 0000 021D 
; 0000 021E     if (_chose == 2)
_0x9A:
	CPI  R17,2
	BRNE _0x9B
; 0000 021F     {
; 0000 0220       sprintf(buff, "Set year=%d  >", year);
	CALL SUBOPT_0x18
...
; 0000 0223     }
; 0000 0224 
; 0000 0225     if (PINA .1 == 0 & _chose == 1)
_0x9B:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0xF
	BREQ _0x9C
; 0000 0226     { // UP     month
; 0000 0227       while (PINA .1 == 0)
_0x9D:
	SBIS 0x19,1
; 0000 0228         ;
	RJMP _0x9D
...
_0xA0:
; 0000 022D 
; 0000 022E     if (PINA .0 == 0 & _chose == 1)
_0x9C:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0xF
	BREQ _0xA1
; 0000 022F     { // DOWN    month
; 0000 0230       while (PINA .0 == 0)
_0xA2:
	SBIS 0x19,0
; 0000 0231         ;
	RJMP _0xA2
...
_0xA5:
; 0000 0236 
; 0000 0237     if (PINA .1 == 0 & _chose == 0)
_0xA1:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0xE
	BREQ _0xA6
; 0000 0238     { // UP    day
; 0000 0239       while (PINA .1 == 0)
_0xA7:
	SBIS 0x19,1
; 0000 023A         ;
	RJMP _0xA7
...
_0xAA:
; 0000 0240 
; 0000 0241     if (PINA .0 == 0 & _chose == 0)
_0xA6:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0xE
	BREQ _0xAB
; 0000 0242     { // DOWN    day
; 0000 0243       while (PINA .0 == 0)
_0xAC:
	SBIS 0x19,0
; 0000 0244         ;
	RJMP _0xAC
...
_0xAF:
; 0000 024A 
; 0000 024B     if (PINA .0 == 0 & _chose == 2)
_0xAB:
	CALL SUBOPT_0x1B
	CALL SUBOPT_0x10
	BREQ _0xB0
; 0000 024C     { // DOWN    year
; 0000 024D       while (PINA .0 == 0)
_0xB1:
	SBIS 0x19,0
; 0000 024E         ;
	RJMP _0xB1
...
_0xB4:
; 0000 0253 
; 0000 0254     if (PINA .1 == 0 & _chose == 2)
_0xB0:
	CALL SUBOPT_0x1A
	CALL SUBOPT_0x10
	BREQ _0xB5
; 0000 0255     { // UP    year
; 0000 0256       while (PINA .1 == 0)
_0xB6:
	SBIS 0x19,1
; 0000 0257         ;
	RJMP _0xB6
; 0000 0258       year++;
	...
	ST   -X,R31
	ST   -X,R30
; 0000 0259       // if(year>1404)
; 0000 025A       // year=0;
; 0000 025B     }
; 0000 025C 
; 0000 025D     if (PINA .3 == 0)
_0xB5:
	SBIC 0x19,3
	RJMP _0xB9
; 0000 025E     { // NEXT
; 0000 025F       while (PINA .3 == 0)
_0xBA:
	SBIS 0x19,3
; 0000 0260         ;
	RJMP _0xBA
...
_0xBD:
; 0000 0265 
; 0000 0266     if (PINA .4 == 0)
_0xB9:
	SBIC 0x19,4
	RJMP _0xBE
; 0000 0267     { // Back
; 0000 0268       while (PINA .4 == 0)
_0xBF:
	SBIS 0x19,4
; 0000 0269         ;
	RJMP _0xBF
