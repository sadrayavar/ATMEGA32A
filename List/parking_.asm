...
; .FSTART _in_out_search
	PUSH R15
; 0000 0186   char t_month = month, line[17], line2[17];
; 0000 0187   char i_temp = day_index;
...
; 0000 018A   {
; 0000 018B 
; 0000 018C     if (PINA .1 == 0)
	SBIC 0x19,1
	RJMP _0x75
; 0000 018D     { // UP
; 0000 018E       while (PINA .1 == 0)
_0x76:
	SBIS 0x19,1
; 0000 018F         ;
	RJMP _0x76
; 0000 0190       i_temp++;
	SUBI R16,-1
; 0000 0191 
; 0000 0192       if (i_temp > day_index & bit_m == 0)
	CALL SUBOPT_0xB
	MOV  R26,R16
	CALL __GTB12U
	CALL SUBOPT_0x1E
...
; 0000 0197       }
; 0000 0198 
; 0000 0199       if (t_month <= 6 & i_temp > 31 & bit_m == 1)
_0x79:
	MOV  R26,R17
	LDI  R30,LOW(6)
	CALL __LEB12U
...
; 0000 019E       }
; 0000 019F 
; 0000 01A0       if (t_month > 6 & i_temp > 30 & bit_m == 1)
_0x7A:
	MOV  R26,R17
	LDI  R30,LOW(6)
	CALL __GTB12U
...
; 0000 01A5       }
; 0000 01A6 
; 0000 01A7       if (t_month == 12 & i_temp > 29 & bit_m == 1)
_0x7B:
	MOV  R26,R17
	LDI  R30,LOW(12)
	CALL __EQB12
...
_0x7E:
; 0000 01B4 
; 0000 01B5     if (PINA .0 == 0)
_0x75:
	SBIC 0x19,0
	RJMP _0x7F
; 0000 01B6     { // DOWN
; 0000 01B7       while (PINA .0 == 0)
_0x80:
	SBIS 0x19,0
; 0000 01B8         ;
	RJMP _0x80
...
; 0000 01D0       }
; 0000 01D1 
; 0000 01D2       if (i_temp < day_index & bit_m == 1)
_0x83:
	CALL SUBOPT_0xB
	MOV  R26,R16
	CALL __LTB12U
...
; 0000 01D7       }
; 0000 01D8 
; 0000 01D9       if (t_month == 0)
_0x89:
	CPI  R17,0
	BRNE _0x8A
; 0000 01DA         t_month = 12;
	LDI  R17,LOW(12)
; 0000 01DB 
; 0000 01DC       if (t_month > 12)
_0x8A:
	CPI  R17,13
	BRLO _0x8B
; 0000 01DD         t_month = 1;
...
_0x8B:
; 0000 01DF 
; 0000 01E0     sprintf(line, "%d/%d/%d ", year, t_month, i_temp);
_0x7F:
	MOVW R30,R28
	ADIW R30,19
	ST   -Y,R31
	...
	CALL _sprintf
	ADIW R28,16
; 0000 01E1     sprintf(line2, "in=%d out=%d", enter_array[i_temp], exit_array[i_temp]);
	MOVW R30,R28
	ADIW R30,2
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 01E3     lcd_clear();
	CALL _lcd_clear
; 0000 01E4     lcd_puts(line);
	MOVW R26,R28
	ADIW R26,19
	CALL _lcd_puts
; 0000 01E5     lcd_gotoxy(0, 1);
	CALL SUBOPT_0x9
; 0000 01E6     lcd_puts(line2);
	MOVW R26,R28
	ADIW R26,2
	CALL _lcd_puts
; 0000 01E7 
; 0000 01E8     if (PINA .4 == 0)
	SBIC 0x19,4
	RJMP _0x8C
; 0000 01E9     { // Back
; 0000 01EA       while (PINA .4 == 0)
_0x8D:
	SBIS 0x19,4
; 0000 01EB         ;
	RJMP _0x8D
...
_0x90:
; 0000 01F8   {
; 0000 01F9     sprintf(line, "Reserved=%d", reserved);
	CALL SUBOPT_0x10
	...
	CALL SUBOPT_0x19
; 0000 01FA     lcd_clear();
; 0000 01FB     lcd_puts(line);
; 0000 01FC 
; 0000 01FD     if (PINA .1 == 0)
	SBIC 0x19,1
	RJMP _0x93
; 0000 01FE     {
; 0000 01FF       while (PINA .1 == 0)
_0x94:
	SBIS 0x19,1
; 0000 0200         ;
	RJMP _0x94
...
; 0000 0203     }
; 0000 0204 
; 0000 0205     if (reserved >= init_capacity)
_0x93:
	MOV  R26,R8
	LDI  R30,LOW(10)
	LDI  R27,0
	...
	BRLT _0x97
; 0000 0206     {
; 0000 0207       reserved = init_capacity - 1;
	LDI  R30,LOW(9)
	MOV  R8,R30
; 0000 0208     }
; 0000 0209 
; 0000 020A     if (PINA .0 == 0)
_0x97:
	SBIC 0x19,0
	RJMP _0x98
; 0000 020B     {
; 0000 020C       while (PINA .0 == 0)
_0x99:
	SBIS 0x19,0
; 0000 020D         ;
	RJMP _0x99
...
; 0000 0210     }
; 0000 0211 
; 0000 0212     if (reserved <= 0)
_0x98:
	LDI  R30,LOW(0)
	CP   R30,R8
	BRLT _0x9C
; 0000 0213     {
; 0000 0214       reserved = 0;
	CLR  R8
; 0000 0215     }
; 0000 0216 
; 0000 0217     if (PINA .4 == 0)
_0x9C:
	SBIC 0x19,4
	RJMP _0x9D
; 0000 0218     { // Back
; 0000 0219       while (PINA .4 == 0)
_0x9E:
	SBIS 0x19,4
; 0000 021A         ;
	RJMP _0x9E
...
_set_date:
; .FSTART _set_date
; 0000 0224   char choice = 0;
; 0000 0225   char line[17];
; 0000 0226   while (1)
	SBIW R28,17
	ST   -Y,R17
;	choice -> R17
...
_0xA1:
; 0000 0227   {
; 0000 0228     if (choice == 1)
	CPI  R17,1
	BRNE _0xA4
; 0000 0229     {
; 0000 022A       sprintf(line, "Set month=%d  >", month);
	CALL SUBOPT_0x22
	...
	CALL SUBOPT_0x23
; 0000 022B       lcd_clear();
; 0000 022C       lcd_puts(line);
; 0000 022D     }
; 0000 022E 
; 0000 022F     if (choice == 0)
_0xA4:
	CPI  R17,0
	BRNE _0xA5
; 0000 0230     {
; 0000 0231       sprintf(line, "Set day=%d  >", day);
	CALL SUBOPT_0x22
	...
	CALL SUBOPT_0x23
; 0000 0232       lcd_clear();
; 0000 0233       lcd_puts(line);
; 0000 0234     }
; 0000 0235 
; 0000 0236     if (choice == 2)
_0xA5:
	CPI  R17,2
	BRNE _0xA6
; 0000 0237     {
; 0000 0238       sprintf(line, "Set year=%d  >", year);
	CALL SUBOPT_0x22
	...
	CALL SUBOPT_0x23
; 0000 0239       lcd_clear();
; 0000 023A       lcd_puts(line);
; 0000 023B     }
; 0000 023C 
; 0000 023D     if (PINA .1 == 0 & choice == 1)
_0xA6:
	CALL SUBOPT_0x24
	CALL SUBOPT_0x17
	BREQ _0xA7
; 0000 023E     { // UP     month
; 0000 023F       while (PINA .1 == 0)
_0xA8:
	SBIS 0x19,1
; 0000 0240         ;
	RJMP _0xA8
...
_0xAB:
; 0000 0245 
; 0000 0246     if (PINA .0 == 0 & choice == 1)
_0xA7:
	CALL SUBOPT_0x25
	CALL SUBOPT_0x17
	BREQ _0xAC
; 0000 0247     { // DOWN    month
...
_0xB0:
; 0000 024E 
; 0000 024F     if (PINA .1 == 0 & choice == 0)
_0xAC:
	CALL SUBOPT_0x24
	CALL SUBOPT_0x16
	BREQ _0xB1
...
_0xB5:
; 0000 0258 
; 0000 0259     if (PINA .0 == 0 & choice == 0)
_0xB1:
	CALL SUBOPT_0x25
	CALL SUBOPT_0x16
	BREQ _0xB6
...
_0xBA:
; 0000 0262 
; 0000 0263     if (PINA .0 == 0 & choice == 2)
_0xB6:
	CALL SUBOPT_0x25
	CALL SUBOPT_0x18
	BREQ _0xBB
; 0000 0264     { // DOWN    year
; 0000 0265       while (PINA .0 == 0)
_0xBC:
	SBIS 0x19,0
; 0000 0266         ;
	RJMP _0xBC
...
_0xBF:
; 0000 026B 
; 0000 026C     if (PINA .1 == 0 & choice == 2)
_0xBB:
	CALL SUBOPT_0x24
	CALL SUBOPT_0x18
	BREQ _0xC0
; 0000 026D     { // UP    year
; 0000 026E       while (PINA .1 == 0)
_0xC1:
	SBIS 0x19,1
; 0000 026F         ;
	RJMP _0xC1
; 0000 0270       year++;
	...
	ST   -X,R31
	ST   -X,R30
; 0000 0271       // if(year>1404)
; 0000 0272       // year=0;
; 0000 0273     }
; 0000 0274 
; 0000 0275     if (PINA .3 == 0)
_0xC0:
	SBIC 0x19,3
	RJMP _0xC4
; 0000 0276     { // NEXT
; 0000 0277       while (PINA .3 == 0)
_0xC5:
	SBIS 0x19,3
; 0000 0278         ;
	RJMP _0xC5
...
_0xC8:
; 0000 027D 
; 0000 027E     if (PINA .4 == 0)
_0xC4:
	SBIC 0x19,4
	RJMP _0xC9
; 0000 027F     { // Back
; 0000 0280       while (PINA .4 == 0)
_0xCA:
	SBIS 0x19,4
; 0000 0281         ;
	RJMP _0xCA
